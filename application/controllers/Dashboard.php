...
class Dashboard extends CI_Controller {
	...
	{	
		...
		$this->data['count_rusak']=$this->db->query("SELECT * FROM tbl_rusak")->num_rows();
		$this->data['count_laporanbuku']=$this->db->query("SELECT * FROM tbl_buku")->num_rows();
		$this->data['count_laporandatapengguna']=$this->db->query("SELECT * FROM tbl_login")->num_rows();
		$this->data['count_laporan']=$this->db->query("SELECT * FROM tbl_pinjam WHERE status = 'Dipinjam'")->num_rows();
